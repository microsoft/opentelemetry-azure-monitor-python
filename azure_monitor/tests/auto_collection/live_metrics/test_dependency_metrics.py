...
from azure_monitor.sdk.auto_collection.live_metrics import dependency_metrics
...
class TestDependencyLiveMetrics(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_constructor(self):
        ...
        metrics_collector = dependency_metrics.DependencyLiveMetrics(
            meter=mock_meter,
    ...
    @mock.patch(
        "azure_monitor.sdk.auto_collection.live_metrics.dependency_metrics.time"
    )
